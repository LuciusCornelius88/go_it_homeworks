from notes_manager.code.abstract_methods import RepresentObjects
from notes_manager.code.commands_handler import FirstOrderCommands, SecondOrderCommands
